...
days_test = 7 # divide data into two subsets: Train & Test, of which the test set is the last 10 days
len_test = T * days_test
map_height, map_width = 20, 24  # grid size
original_filename = 'TaxiCQ_grid.h5'
