...
for p in cs:
    ...
    days_test = 4*7   # divide data into two subsets: Train & Test, of which the test set is the last 4 weeks
    ...
    model = ST3DNet(c_conf=c_conf, p_conf=p_conf, t_conf=t_conf, external_dim=external_dim,   nb_residual_unit=nb_residual_unit)
